...
describe('simple Pagination', () => {
  ...
  it('input change value will emit onChange when input blur', () => {
    ...
    const greaterCurrent = component.find('.pagination-qin-simple');
  ...
  it('should return to 1 when blur goto input in uncontrol mode', () => {
    ...
    const input = component.find('.pagination-qin-simple').find('input');
  ...
  it('no quick jump', () => {
    const simplePagers = wrapper.find('.pagination-qin-simple-pager');
