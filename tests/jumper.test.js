...
describe('Pagination with jumper', () => {
  ...
  it('should not jumper when click pre/next button', () => {
    ...
    const mockEvent = {
      relatedTarget: {
        className: 'pagination-qin-item-link',
      },
    };
...
describe('simple quick jumper', () => {
  ...
  it('should quick jump to expect page', () => {
    const quickJumper = wrapper.find('.pagination-qin-simple');
    const input = quickJumper.find('input');
  ...
  it('goButton could be true', () => {
    ...
    expect(
      wrapper.find('.pagination-qin-options-quick-jumper-button').exists(),
    ).toBe(true);
  });
  ...
  it('Quick Jumper should hide when only one page', () => {
    ...
    expect(wrapper.find('.pagination-qin-options-quick-jumper').exists()).toBe(
      false,
    );
  });
